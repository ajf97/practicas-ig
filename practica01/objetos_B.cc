...
_octaedro::_octaedro(float tam, float al)
{
	...
	caras[4]._0=0;caras[4]._2=5;caras[4]._1=1;
	caras[5]._0=1;caras[5]._2=5;caras[5]._1=2;
	caras[6]._0=2;caras[6]._2=5;caras[6]._1=3;
	caras[7]._0=3;caras[7]._2=5;caras[7]._1=0;
